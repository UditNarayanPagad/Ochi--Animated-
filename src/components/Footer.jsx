...
const Footer = () => {
  return (
    <div className="w-full p-10  mt-[-3vw] text-white rounded-t-3xl bg-slate-700">
      <div className="flex">
        <div className="h-screen w-[50%] ">
          <h1 className="text-[100px] tracking-tighter font-semibold mt-[3vw]">
            EYE-
          </h1>
          <h1 className="text-[100px] tracking-tighter font-semibold mt-[-5vw]">
            OPENING
          </h1>
        </div>
        <div>
      ...
      <div className="w-full flex justify-between">
        ...
        <h1 className="text-zinc-400">
          ...
          <a className="underline text-zinc-400" href="">
            Legal Terms
          </a>
        </h1>
